...
const About = () => {
  ...
  return (
    <div className="about-container" ref={containerRef} style={{backgroundColor:'#181818'}}>
      ...
      {/* Decorative Elements */}
      <div className="glowing-circle circle-1 parallax-element"></div>
      <div className="glowing-circle circle-2 parallax-element"></div>
      <div className="glowing-circle circle-3 parallax-element"></div>
